...
def generate_gradcam_heatmaps(images, predicted, paths, experiment_result_folder, cam, target_size=(1056, 1056)):
    ...
    Parameters:
        images: The input image tensor (already moved to device) fed to the model.
...
if __name__ == "__main__":
    ...
    RESULT_FOLDER = r'/home/shun/Project/Grains-Classification/Result_2025.2.18/ST_3_class_frozen/evaluation'
    MODEL_WEIGHTS_PATH = r'/home/shun/Project/Grains-Classification/Result_2025.2.18/ST_3_class_frozen/checkpoints/best_model_epoch_30_val_loss_0.0044.pth'
    num_classes = 3
    batch_size = 1
    seed = 10086
    model_type = "swin"  # Options: "resnet", "swin" or "swin_v2"
